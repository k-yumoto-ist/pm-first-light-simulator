...
export default function PMSimulator() {
  ...
  const askTopic = (topicId: string) => {
    if (!selected || game.asked.includes(topicId) || game.actionsLeft <= 0) return;
