...
test("keeps the light-mode decision loop intact", async () => {
  const [page, hub, simulator, actions, actionDetail, confirmDialog, resultStep, projectLog] = await Promise.all([
    readFile(new URL("app/page.tsx", root), "utf8"), readFile(new URL("app/components/SimulatorHub.tsx", root), "utf8"), readFile(new URL("app/components/PMSimulator.tsx", root), "utf8"), readFile(new URL("app/data/actions.ts", root), "utf8"), readFile(new URL("app/components/ActionDetailModal.tsx", root), "utf8"), readFile(new URL("app/components/ActionConfirmDialog.tsx", root), "utf8"), readFile(new URL("app/components/ResultStep.tsx", root), "utf8"), readFile(new URL("app/components/ProjectLog.tsx", root), "utf8"),
  ]);
